        ...
        <section class="section">
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form form-horizontal" action="/siswa/update/{{$data->id}}" method="post"
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="number" class="form-control" name="no_absen" value="{{$data->no_absen}}">
                                        </div>
                                        <div class="col-md-4">
                                            <label>Kelas</label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <div class="form-group">
                                                <select class="choices form-select" name="kelas_id" required>
                                                    ...
                                                    <option  value="{{$kel->id}}" {{($data->kelas_id == $kel->id) ? 'selected':''}}>{{$kel->nama}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
